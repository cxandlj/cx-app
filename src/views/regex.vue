                ...
                <el-col :span="24">
                    <el-card class="search-box-card">
                        <template #header>
                            <div class="card-header">
                                <span>查找</span>
                                <el-button type="success" @click="matchText"
                                    >匹配</el-button
                                >
                            </div>
                        </template>
                        ...
                        <el-row>
                            <el-col
                                :span="24"
                                style="padding: 0 0 5px 0; margin-top: -10px"
                            >
                                <el-checkbox-group v-model="searchCheckList">
                                    <el-checkbox
                                        v-for="item in regex_options.filter(
                                            (p) => p.code == 'i'
                                        )"
                                        :key="item.code"
                                        :label="item.code"
                ...
                <el-col :span="24">
                    <el-card class="replace-box-card">
                        <template #header>
                            <div class="card-header">
                                <span>替换</span>
                                <el-button type="success" @click="replaceText"
                                    >替换</el-button
                                >
                            </div>
                        </template>
        ...
        <el-col :span="8" justify="center" class="regex-col">
            <el-card class="box-card">
                <template #header>
                    <div class="card-header">
                        <span>处理结果</span>
                        <el-button type="success" @click="copyOut"
                            >复制结果</el-button
                        >
                    </div>
                </template>
...
/* 设置 el-input 及其内部 textarea 的高度为 100% */
.box-card:deep(.el-textarea) {
    height: 100%;
}
